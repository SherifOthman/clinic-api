...
public class DemoClinicContext
{
    ...
    public Guid BranchId        { get; init; }   // Main Branch
    public Guid Branch2Id       { get; init; }   // Downtown Branch
    public Guid OwnerUserId     { get; init; }

    // ── Doctor 1: Time-based (Main Branch) ───────────────────────────────────
    ...
    // ── Doctor 3: Time-based (Downtown Branch) ────────────────────────────────
