...
public class GetMedicalSuppliesEndpoint : IEndpoint
{
    public static void Map(IEndpointRouteBuilder app)
    {
        app.MapGet("/branches/{clinicBranchId:guid}/medical-supplies", HandleAsync)
            ...
            .Produces<PaginatedResult<MedicalSupplyDto>>(StatusCodes.Status200OK)
        ...
        CancellationToken ct = default)
    {
        ...
        var supplies = await query
            ...
            .Select(ms => new MedicalSupplyDto(
                ms.Id,
                ms.Name,
                ms.QuantityInStock,
                ms.UnitPrice,
        ...
        return Results.Ok(new PaginatedResult<MedicalSupplyDto>(
            supplies,
            totalCount,
            pageNumber,
            pageSize
    ...
    public record MedicalSupplyDto(
        Guid Id,
        string Name,
        int QuantityInStock,
        decimal UnitPrice,
