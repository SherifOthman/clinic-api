...
public class InviteStaffCommandHandler : IRequestHandler<InviteStaffCommand, Result<StaffInvitationDto>>
{
    ...
    public async Task<Result<StaffInvitationDto>> Handle(InviteStaffCommand request, CancellationToken cancellationToken)
    {
        ...
        var emailBody = GetInvitationEmailTemplate(dto.FirstName, dto.LastName, user.FirstName, user.LastName, invitationLink, dto.UserType);
    ...
    private string GetInvitationEmailTemplate(string firstName, string lastName, string inviterFirstName, string inviterLastName, string invitationLink, UserType userType)
    {
