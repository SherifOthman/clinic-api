...
public class Invoice : TenantEntity
{
    ...
    public bool IsOverdue(DateTimeOffset currentDate) => DueDate.HasValue && currentDate > DueDate.Value && Status != InvoiceStatus.FullyPaid && Status != InvoiceStatus.Cancelled;
}
